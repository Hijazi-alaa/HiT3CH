...
export const translations = {
  sv: {
    ...
    why_point2_title: "Partnerskap i fokus",
    why_point2_text: "Nära samarbete, tydliga milstolpar och löpande support efter go‑live.",
    why_point3_title: "Efterlevnad du kan lita på",
    why_point3_text: "EU‑hosting, GDPR‑praxis och säkerhet som utgångspunkt i varje uppdrag.",
    why_point4_title: "Lokal förståelse, global metod",
    why_point4_text: "Svensk kontext med internationell erfarenhet och moderna AI‑metoder.",

    why_stat1_value: "2–4v",
    why_stat1_label: "Typisk start → go‑live",
    why_stat2_value: "30–60%",
    why_stat2_label: "Mindre repetitivt arbete",
    why_stat3_value: "24/7",
    why_stat3_label: "Tillgänglighet med agenter",
    why_stat4_value: "SE / EN",
    why_stat4_label: "Svenska och engelska",
    ...
    consult_stat1_l: "Från start till go-live",
    consult_stat2_v: "30–60%",
    consult_stat2_l: "Mindre repetitivt arbete",
    consult_note: "Vi återkommer inom 1 arbetsdag.",

    consult_modal_title: "Boka gratis konsultation",
    consult_modal_sub: "Fyll i formuläret så hör vi av oss för att boka en tid.",
    consult_privacy: "Dina uppgifter behandlas konfidentiellt och används endast för att svara på din förfrågan.",
    ...
    form_email: "E‑post",
    form_message: "Berätta kort vad du vill lösa",
    form_submit: "Skicka",
    ...
    // Legacy keys kept for safety (not used by current HTML)
    hero_primary: "Boka ett möte",
    hero_secondary: "Läs mer",
    solutions_how_title: "Så kan vi hjälpa dig",
    solution1_title: "AI Kundsupport",
    solution1_text: "Röst- och chattassistenter som avlastar kundservice och höjer nöjdheten.",
  ...
  en: {
    ...
    hero_title: "AI solutions tailored for your business",
    ...
    why_point1_text: "We fit the automation to your processes and stack — not the other way around.",
    why_point2_title: "Partnership mindset",
    why_point2_text: "Hands‑on collaboration, clear milestones, and ongoing support post go‑live.",
    why_point3_title: "Compliance you can trust",
    why_point3_text: "EU hosting, GDPR practices, and security by design for every engagement.",
    why_point4_title: "Local insight, global practice",
    why_point4_text: "Swedish context with international experience and modern AI methods.",

    why_stat1_value: "2–4w",
    why_stat1_label: "Typical start → go‑live",
    why_stat2_value: "30–60%",
    why_stat2_label: "Less repetitive work",
    why_stat3_value: "24/7",
    why_stat3_label: "Availability with agents",
    why_stat4_value: "SE / EN",
    why_stat4_label: "Swedish and English",

    why_note: "Figures reflect pilots and common engagements. Actual results depend on data and integrations.",
    ...
    consult_stat1_l: "Start to go-live",
    consult_stat2_v: "30–60%",
    consult_stat2_l: "Less repetitive work",
    consult_note: "We reply within 1 business day.",

    consult_modal_title: "Book free consultation",
    consult_modal_sub: "Fill in the form and we’ll get back to schedule a time.",
    consult_privacy: "Your details are kept confidential and only used to respond to your inquiry.",

    // Form
    form_name: "Name",
    form_company: "Company",
    form_email: "Email",
    form_message: "Briefly describe what you want to solve",
    form_submit: "Send",
    ...
    // Legacy keys kept for safety (not used by current HTML)
    hero_primary: "Book a meeting",
    hero_secondary: "Learn more",
    solutions_how_title: "How we can help",
    solution1_title: "AI Customer Support",
    solution1_text: "Voice and chat assistants that reduce load and raise satisfaction.",
